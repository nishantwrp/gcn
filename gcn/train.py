...
from utils import *
from models import GCN, MLP, EXP1
...
flags.DEFINE_string('model', 'gcn', 'Model string.')  # 'gcn', 'gcn_cheby', 'dense', 'exp1', 'exp2', 'exp3', 'exp4'
...
flags.DEFINE_integer('l1n', 3, 'Neighbours to consider in input layer')
